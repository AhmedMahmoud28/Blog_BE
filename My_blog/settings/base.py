...
# local apps
LOCAL_APPS = ["My_blog.userapp", "My_blog.blogapp", "My_blog.services"]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "My_blog.services.paginator.CustomPagination",
    "PAGE_SIZE": 5,
...
""" SWAGGER_SETTINGS """
SWAGGER_SETTINGS = {
    "DEFAULT_AUTO_SCHEMA_CLASS": "My_blog.swagger.CustomSwaggerAutoSchema",
